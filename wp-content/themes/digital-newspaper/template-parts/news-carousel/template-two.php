...
<div <?php if( isset( $options->blockId ) && !empty($options->blockId) ) echo 'id="' .esc_attr( $options->blockId ). '"'; ?> class="news-carousel <?php echo esc_attr( 'layout--' . $options->layout ); ?>">
    ...
    ?>
    <div class="news-carousel-post-wrap <?php echo esc_attr($view_allclass); ?>" data-dots="<?php echo esc_attr( digital_newspaper_bool_to_string( $options->dots ) ); ?>" data-loop="<?php echo esc_attr( digital_newspaper_bool_to_string( $options->loop ) ); ?>" data-arrows="<?php echo esc_attr( digital_newspaper_bool_to_string( $options->arrows ) ); ?>" data-auto="<?php echo esc_attr( digital_newspaper_bool_to_string( $options->auto ) ); ?>" data-columns="<?php echo absint( $options->columns ); ?>">
        <?php
