...
jQuery(document).ready( function($) {
    function digital_newspaper_widgets_handler() {
        // multicheckbox field
        $( ".digital-newspaper-multicheckbox-field" ).on( "click, change", ".multicheckbox-content input", function() {
            var _this = $(this), parent = _this.parents( ".digital-newspaper-multicheckbox-field" ), currentVal, currentFieldVal = parent.find( ".widefat" ).val();
        ...
        // checkbox field
        $( ".digital-newspaper-checkbox-field" ).on( "click, change", "input", function() {
            var _this = $(this)
            if( _this.is(":checked") ) {
                _this.val( "1" )
            } else {
        ...
        // upload field
        $( ".digital-newspaper-upload-field" ).on( "click", ".upload-trigger", function(event) {
        ...
        // remove image
        $( ".digital-newspaper-upload-field" ).on( "click", ".upload-buttons .remove-image", function(event) {
            event.preventDefault();
            var _this = $(this);
        ...
        // icon text handler
        var iconTextContainer = $( ".digital-newspaper-icon-text-field" )
    ...
    digital_newspaper_widgets_handler();
