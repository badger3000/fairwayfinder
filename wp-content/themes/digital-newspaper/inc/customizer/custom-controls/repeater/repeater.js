...
jQuery(document).ready(function($) {
    ...
    function digitalNewspaperClickOutSideElm(elm, callback) {
    ...
    $( ".digital-newspaper-repeater-control" ).each(function() {
        var container = $(this)
        ...
        container.on( "click", ".fontawesome-icon-picker .icons-list i", function() {
            ...
            _this.parents( ".digital-newspaper-repeater-item" ).find( ".item-heading-wrap .item-heading" ).text(newValue.split("-")[1])
            repeater_value_refresh(_this);
        })

        // sortable handler
        container.find( ".digital-newspaper-repeater-control-inner" ).sortable({
        orientation: "vertical",
        items: "> .digital-newspaper-repeater-item",
        ...
        container.on( "click", ".display-icon", function() {
            ...
            _this.parents( ".digital-newspaper-repeater-item" ).toggleClass( "not-visible visible" )
            // _this.parent().next().toggleClass("isShow isHidden");
            // _this.parents( ".digital-newspaper-repeater-item" ).toggleClass("popupActive");
            repeater_value_refresh(_this)
        })
        ...
        container.on( "click", ".add-new-item", function(e) {
            ...
            digitalNewspaperClickOutSideElm( fieldsPopup, function() {
                fieldsPopup.parents( ".digital-newspaper-repeater-item" ).removeClass("popupActive")
        ...
        container.on( "click", ".digital-newspaper-repeater-item.visible .settings-icon", function() {
            $(this).parents(".digital-newspaper-repeater-item").siblings().removeClass("popupActive").find(".item-control-fields").removeClass("isShow").addClass("isHidden")
            $(this).parents(".digital-newspaper-repeater-item").siblings().find( ".fontawesome-icon-picker .icons-list" ).hide()
            $(this).parents(".digital-newspaper-repeater-item").toggleClass("popupActive")
            $(this).parent().next().toggleClass( "isHidden isShow" );
            $(this).parent().next().find( ".fontawesome-icon-picker .icons-list" ).hide();
            // close popup on outside click
            var fieldsPopup =  $(this).parents(".digital-newspaper-repeater-item").find( ".item-control-fields.isShow" )
            digitalNewspaperClickOutSideElm( fieldsPopup, function() {
                fieldsPopup.parents( ".digital-newspaper-repeater-item" ).removeClass("popupActive")
                fieldsPopup.removeClass( "isShow" ).addClass( "isHidden" )
            })
        ...
        container.on( "change keyup", ".digital-newspaper-repeater-item .repeater-field-value-holder", function() {
            var _this = $(this)
            repeater_value_refresh(_this)
        })
    ...
    function repeater_value_refresh( _this ) {
        var controlValue = [], container =  ( _this.hasClass( "digital-newspaper-repeater-control" ) ) ? _this : _this.parents( ".digital-newspaper-repeater-control" );
        container.find( ".digital-newspaper-repeater-item" ).each(function() {
            var newValue = {}
