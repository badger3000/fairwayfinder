  ...
  ?>
            <div class="single-related-posts-section-wrap layout--list">
                <div class="single-related-posts-section">
                    ...
                    <?php
                        if( $related_posts_title ) echo '<h2 class="digital-newspaper-block-title"><span>' .esc_html( $related_posts_title ). '</span></h2>';
...
if( ! function_exists( 'digital_newspaper_main_banner_related_posts_html' ) ) :
    /**
     * Single related posts
     * 
     * @package Digital Newspaper
     */
    function digital_newspaper_main_banner_related_posts_html($excludePostId) {
        $main_banner_related_posts_option = DN\digital_newspaper_get_customizer_option( 'main_banner_related_posts_option' );
...
add_action( 'digital_newspaper_main_banner_post_append_hook', 'digital_newspaper_main_banner_related_posts_html', 10, 1 );