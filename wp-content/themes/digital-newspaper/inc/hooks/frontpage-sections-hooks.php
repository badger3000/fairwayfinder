...
if( ! function_exists( 'digital_newspaper_main_banner_part' ) ) :
     ...
     */
     function digital_newspaper_main_banner_part() {
        ...
        ?>
            <section id="main-banner-section" class="digital-newspaper-section banner-layout--five <?php echo esc_attr( $section_column_sort_class ); ?> <?php echo esc_attr( 'width-' . $main_banner_width_layout ); ?>">
                <div class="digital-newspaper-container">
                    <div class="row">
                        <?php get_template_part( 'template-parts/main-banner/template', 'five', $main_banner_args ); ?>
                    </div>
                </div>
            </section>
        <?php
