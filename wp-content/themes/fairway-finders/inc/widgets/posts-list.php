<?php
/**
 * Adds Digital_Newspaper_Posts_List_Widget widget.
 * 
 * @package Digital Newspaper
 * @since 1.0.0
 */
class Digital_Newspaper_Posts_List_Widget extends WP_Widget {
    /**
                            ...
                            <div class="post-item format-standard digital-newspaper-category-no-bk">
                                <div class="post_thumb_image post-thumb <?php if( !$thumbnail_url ) echo esc_attr('no-feat-img'); ?>">
                                    <?php
                                        ...
                                        if( $numbering > 1 ) echo '<span class="post-numbering">' . digital_newspaper_numbering_with_pad_format($numbering). '</span>';
                                    ?>
                                </div>
                                <div class="post-content-wrap card__content">
                                    <?php
                                        ...
                                        <div class="digital-newspaper-post-title card__content-title post-title">
                                            ...
                                            <?php if( $numbering == 1 ) echo '<span class="post-numbering">' . digital_newspaper_numbering_with_pad_format($numbering). '</span>'; ?>
                                        </div>
                                    <?php
                                        if( $numbering == 1 ) : ?>
                                            <div class="post-meta">
...
} // class Digital_Newspaper_Posts_List_Widget